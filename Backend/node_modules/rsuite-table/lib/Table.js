...
var _reactIs = require("./utils/react-is");
...
var Table = /*#__PURE__*/_react["default"].forwardRef(function (props, ref) {
  ...
  var isAutoHeight = (0, _react.useMemo)(function () {
    return autoHeight && !maxHeight;
  }, [autoHeight, maxHeight]);
  var _useClassNames = (0, _hooks.useClassNames)(classPrefix, typeof classPrefix !== 'undefined'),
  ...
  var _useControlled = (0, _hooks.useControlled)(expandedRowKeysProp, defaultExpandAllRows ? (0, _utils.findRowKeys)(dataProp, rowKey, (0, _isFunction["default"])(renderRowExpandedProp)) : defaultExpandedRowKeys || []),
    expandedRowKeys = _useControlled[0],
    setExpandedRowKeys = _useControlled[1];
  var data = (0, _hooks.useTableData)({
    data: dataProp,
    isTree: isTree,
  ...
  var _useTableRows = (0, _hooks.useTableRows)({
      data: dataProp,
      expandedRowKeys: expandedRowKeys,
      wordWrap: wordWrap,
      prefix: prefix
  ...
  var setCssPosition = (0, _react.useRef)((0, _translateDOMPositionXY.getTranslateDOMPositionXY)({
  ...
  var shouldFixedColumn = children.some(function (child) {
    var _child$props;
    return (0, _reactIs.isElement)(child) && (child === null || child === void 0 || (_child$props = child.props) === null || _child$props === void 0 ? void 0 : _child$props.fixed);
  });

  // Check all column properties for the existence of rowSpan.
  var shouldRowSpanColumn = children.some(function (child) {
    var _child$props2;
    return (0, _reactIs.isElement)(child) && (child === null || child === void 0 || (_child$props2 = child.props) === null || _child$props2 === void 0 ? void 0 : _child$props2.rowSpan);
  });
  ...
  var _useTableDimension = (0, _hooks.useTableDimension)({
  ...
  var _usePosition = (0, _hooks.usePosition)({
      data: dataProp,
      height: height,
  ...
  var _useScrollListener = (0, _hooks.useScrollListener)({
      rtl: rtl,
      data: dataProp,
      height: height,
  ...
  var _useCellDescriptor = (0, _hooks.useCellDescriptor)({
      children: children,
      rtl: rtl,
      ...
      if (isUncertainHeight && virtualized || !virtualized) {
        ...
        for (var index = 0; index < data.length; index++) {
          ...
          if (typeof rowHeight === 'function') {
            ...
            nextRowHeight = _maxHeight ? Math.max(_maxHeight + _constants.CELL_PADDING_HEIGHT, rowHeight) : rowHeight;
            cellHeight = nextRowHeight;
            if (expandedRow) {
