...
import type { StandardProps, SortType, RowKeyType, TableLocaleType, TableSizeChangeEventName, RowDataType } from './types';
export interface TableProps<Row extends RowDataType, Key extends RowKeyType> extends Omit<StandardProps, 'onScroll' | 'children'> {
    /**
     ...
     */
    children?: React.ReactNode | React.ReactNode[] | ((props: {
...
export interface TableInstance<Row extends RowDataType, Key extends RowKeyType> extends React.FunctionComponent<TableProps<Row, Key>> {
...
declare const _default: <Row extends RowDataType, Key extends RowKeyType>(props: TableProps<Row, Key> & React.RefAttributes<TableInstance<Row, Key>>) => React.ReactElement;
