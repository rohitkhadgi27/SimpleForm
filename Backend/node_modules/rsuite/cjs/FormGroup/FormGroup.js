 ...
 */
const FormGroup = (0, _utils.forwardRef)((props, ref) => {
  const {
    propsWithDefaults
  } = (0, _hooks.useCustom)('FormGroup', props);
  const {
    as,
  ...
  const controlId = (0, _hooks.useUniqueId)('rs-', controlIdProp);
  const contextValue = (0, _react.useMemo)(() => ({
    controlId
  }), [controlId]);
  return /*#__PURE__*/_react.default.createElement(_FormGroupContext.FormGroupContext.Provider, {
    value: contextValue
