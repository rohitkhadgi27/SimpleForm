...
let DateMode = exports.DateMode = /*#__PURE__*/function (DateMode) {
  DateMode["Date"] = "date";
 ...
 */
const useDateMode = format => {
  const mode = (0, _react.useMemo)(() => {
  ...
  const has = (0, _react.useCallback)(part => {
    switch (part) {
      case 'year':
...
exports.useDateMode = useDateMode;