...
import type { StandardProps, Option, DataProps, HTMLPropsWithoutSelect } from '../types';
 ...
 */
export interface ListboxProps<Multiple = false> extends StandardProps, Partial<DataProps<InnerOption>>, HTMLPropsWithoutSelect {
    groupBy?: string;
